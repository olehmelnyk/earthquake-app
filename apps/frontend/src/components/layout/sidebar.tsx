...
export const Sidebar = ({ className }: SidebarProps) => {
  const menuItems = [
    ...
    { href: '/earthquakes', label: 'Earthquakes', icon: EarthquakeIcon },
  ...
  return (
    <aside className={`pb-12 border-r border-border/40 bg-background ${className}`}>
          ...
          <div className="space-y-1">
            {menuItems.map((item) => (
              <Link
                key={item.href}
                href={item.href}
                className="flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium transition-all hover:text-primary hover:bg-accent/50 hover:border-border/60"
              >
